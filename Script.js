...
// Mengambil data P2P murni dari node terpisah `p2p_requests`
...
// ==========================================
// FITUR P2P: MINTA SALDO ANTARWARGA (BERSIH TOTAL DARI ADMIN)
// ==========================================
...
// BERSIH TOTAL: Hanya dikirim ke p2p_requests (Tidak menyentuh transactions admin sama sekali)
...
// Render Riwayat & Tombol ACC/Tolak Murni P2P
function renderUserTransactions() {
  ...
  globalTransactions.forEach((t) => {
    ...
    // Tombol ACC/Tolak MUNCUL di akun Warga B (targetUser) saat status Pending
    let p2pActionHtml = '';
