    ...
    formDaftar.addEventListener("submit", function (e) {
      ...
      db.ref("users/" + username).once("value", (snap) => {
        if (snap.exists()) {
          ...
          // Status awal 'pending_verification' agar fitur transaksi terkunci sampai setoran awal min. Rp 50.000 di-ACC admin
          const newUserObject = {
...
function bindUserEvents() {
  ...
  // ATURAN 2: Validasi ketat status akun aktif untuk semua fitur transaksi utama
...
// ==========================================
// FIX UTAMA: LOGIKA ACC ADMIN (POTONG SALDO & KAS ARISAN BERTAMBAH SECARA SINKRON)
// ==========================================
function accTrx(trxKey) {
  ...
  // Update status transaksi menjadi 'Disetujui' secara mutlak agar langsung terdeteksi renderAdminAllData
